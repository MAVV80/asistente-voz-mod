...
S -> AV VP
AV -> 'andy'
VP -> V | V OBJ | V DET N | V N | V EN OBJ 
DET -> 'el' | 'la' | 'los' | 'las' | 'al' | 'la'
EN -> 'en'
N -> 'perro' | 'gato' | 'luis' | 'miguel' | 'mana' | 'moderato' | 'jose'
N -> 'notepad' | 'word' | 'edge' | 'documento'
V -> 'canta' | 'escribe' | 'reproduce' | 'reproducir' | 'busca' | 'buscar' | 'abre' | 'abrir' | 'inicia' | 'wikipedia' | 'wikipédia' | 'wiki' | 'significa' | 'significado' | 'definición' | 'define' | 'proximos' | 'partidos' | 'ultimos' | 'resultados'
OBJ -> '__objeto__'
"""
